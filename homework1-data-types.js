...
console.log(null == '', null == null, null == undefined, '' == undefined);
            false           true            true            false
Null дорівнює двом значенням - це null та undefined та означає відсутність значення - порожність і посилання на нього.
А от пуста строка в той час має посилання на комірку пам`яті, яка ще не має данних, але має тип string.
Якось так )
